...
import departments from '@/module-departments/' // 企业部门管理
import employees from '@/module-employees/' // 企业员工管理
import settings from '@/module-settings/' // 企业角色管理
import permissions from '@/module-permissions/' // 企业权限管理
